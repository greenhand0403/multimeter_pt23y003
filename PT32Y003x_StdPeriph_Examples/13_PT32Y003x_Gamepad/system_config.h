...
extern volatile uint32_t g_last_packet_time; // 用于间隔20ms发包记录时间戳
extern uint8_t BLE_NAME_LEGAL; // 用于首次判断蓝牙名称合法

extern volatile uint16_t g_pwm_duty;          // 新增：存储PWM占空比 (0-1000)
extern volatile uint8_t g_servo_angle;        // 新增：存储舵机角度 (0-180)
